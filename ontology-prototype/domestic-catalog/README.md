...
조회·생성 시점(UTC): 2026-09-14T15:11:38.596963+00:00

## 확보한 목록과 칼럼

| 출처 | 등록정보 행 | 출처 안의 고유 목록 키 | 선언된 출력항목명 후보 | 명세에서 확인한 칼럼 | 명세를 확보한 등록정보 |
|---|---:|---:|---:|---:|---:|
| 주소기반산업지원서비스 | 42 | 42 | 0 | 1,316 | 40 |
| 열린국회정보 | 278 | 278 | 0 | 2,188 | 278 |
| 문화 빅데이터 플랫폼 | 92 | 92 | 0 | 1,577 | 92 |
| 부산 Big-데이터웨이브 | 12,551 | 12,551 | 0 | 0 | 0 |
| 충남 올담 | 4,124 | 4,124 | 0 | 9,094 | 644 |
| 문화공공데이터광장 | 938 | 938 | 0 | 7,927 | 468 |
| D-데이터허브 | 19,954 | 19,954 | 0 | 0 | 0 |
| 공공데이터포털 | 108,172 | 95,923 | 640,859 | 911,685 | 67,106 |
| 한국은행 ECOS | 681 | 681 | 0 | 1,182 | 681 |
| 고속도로 공공데이터 포털 | 527 | 527 | 0 | 1,859 | 149 |
| 금융통계정보시스템 FISIS | 740 | 740 | 0 | 19,603 | 740 |
| 식품안전나라 데이터활용서비스 | 178 | 178 | 0 | 1,861 | 169 |
| 산림청 공공데이터 개방목록 | 56 | 56 | 0 | 217 | 15 |
| 게임물관리위원회 Open API | 2 | 2 | 0 | 24 | 2 |
| 경기데이터드림 | 2,267 | 2,267 | 0 | 42,550 | 2,125 |
| 한국산업인력공단 오픈 API | 69 | 69 | 0 | 0 | 0 |
| 한강홍수통제소 Open API | 9 | 9 | 0 | 73 | 9 |
| 인천데이터포털 | 4,382 | 4,382 | 0 | 170 | 7 |
| 제주데이터허브 | 1,259 | 1,259 | 0 | 686 | 93 |
| 전북 빅데이터 허브 | 2,233 | 2,233 | 0 | 0 | 0 |
| KDI Open API | 6 | 6 | 0 | 113 | 6 |
| 기상청 API허브 | 626 | 626 | 0 | 4,709 | 304 |
| 한국콘텐츠진흥원 Open API | 6 | 6 | 0 | 101 | 6 |
| KOSIS 주제별통계 | 268,388 | 268,269 | 0 | 484,085 | 70,653 |
| 국민체육진흥공단 공개 데이터 안내 | 183 | 183 | 0 | 0 | 0 |
| 국가법령정보센터 LAW OPEN DATA | 195 | 195 | 0 | 3,210 | 180 |
| 도서관 정보나루 | 19 | 19 | 0 | 436 | 19 |
| 농림축산식품 공공데이터포털 | 2,142 | 2,142 | 0 | 2,725 | 183 |
| 나이스 교육정보 개방 포털 | 12 | 12 | 0 | 178 | 12 |
| 금융감독원 OpenDART | 85 | 85 | 0 | 2,175 | 85 |
| 서울 열린데이터광장 | 8,272 | 8,272 | 0 | 171,837 | 7,441 |
| SGIS 통계지리정보서비스 | 68 | 68 | 0 | 618 | 67 |
| 울산광역시 데이터포털 | 2,582 | 2,582 | 0 | 0 | 0 |
| 영등포구 열린 데이터 광장 | 153 | 153 | 0 | 4,523 | 150 |

총 등록정보 **441,291행**, 선언된 출력항목명 후보 **640,859개**를 저장했다. 명세 문서별 항목 합계는 **1,427,860개**, 기관별 등록정보에 연결한 반복까지 포함한 항목 수는 **1,676,722개**다.
...
**프로토타입 개념·관계 설계를 위한 자료가 충분하다고 판단해 대량 자동 수집을 종료했다.** [판정 근거](COLLECTION-SUFFICIENCY.md)와 [운영 기록](collection-stop-report.json)을 확인한다. 검색 DB와 파일을 보존하며, 구체적인 관계 검토에 필요한 출처만 추가로 조사한다.
...
30분 간격 후속 수집 예약은 해제했다. 미처리 큐·명세 미확보·오류를 완료로 바꾸지 않는다. 전국 전수 수집 완료와 온톨로지 검증 완료는 아직 아니다.
...
34. **나머지 제공처:** 국내 조사 등록부 125개 중 목록을 일부라도 확보한 34곳 외의 제공처는 미수집으로 남아 있다. 관계 검토에 필요한 출처를 식별하면 해당 목록·명세를 보충한다. 전국 제공처 자체의 완전한 명부도 아직 없다.
