...
조회·생성 시점(UTC): 2026-09-14T12:15:58.939467+00:00
...
| 공공데이터포털 | 108,172 | 95,923 | 640,859 | 839,773 | 58,531 |
...
| KOSIS 주제별통계 | 268,388 | 268,269 | 0 | 426,709 | 60,397 |
...
총 등록정보 **440,356행**, 선언된 출력항목명 후보 **640,859개**를 저장했다. 명세 문서별 항목 합계는 **1,275,759개**, 기관별 등록정보에 연결한 반복까지 포함한 항목 수는 **1,524,621개**다.
...
32. **나머지 제공처:** 국내 조사 등록부 125개 중 목록을 일부라도 확보한 32곳 외의 제공처는 수집 경로·명세 형식을 계속 조사한다. 원문 외부 참조에서 발견한 신규 제공처도 검토한다. 전국 제공처 자체의 완전한 명부도 아직 없다.
